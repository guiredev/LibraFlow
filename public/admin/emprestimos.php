 ...
 * Local: public/admin/emprestimos.php
 * Funcao: Gestao administrativa de emprestimos, devolucoes e atrasos.
 */
// public/admin/emprestimos.php
...
<body>
    <aside>
        ...
        <ul>
            ...
            <li class="nav-section">Operação</li><li><a href="/LibraFlow/public/admin/emprestimos.php" class="ativo"><i class="fas fa-clipboard-list nav-icon" aria-hidden="true"></i> Empréstimos</a></li>
    ...
    <nav>
        <div class="logo-nav"><span>Empréstimos</span></div>
        <div class="right">
    ...
    <div id="modalEmprestimo" class="modal-overlay">
        <div class="modal-conteudo">
            <div class="modal-header">
                <h2><i class="fas fa-book-open" aria-hidden="true"></i> Novo Empréstimo</h2>
            ...
            <div class="modal-body">
                <form id="formEmprestimo" class="form-emprestimo">
                    ...
                    <div class="campo-selecao">
                        ...
                        <button type="button" class="btn-selecionar" onclick="abrirModalLivros()"><i class="fas fa-book" aria-hidden="true"></i> Selecionar</button>
                    </div>

                    <div class="campo-selecao">
                        <input type="text" id="inputAluno" placeholder="Selecione o aluno" readonly onclick="abrirModalAlunos()" required>
                        <button type="button" class="btn-selecionar" onclick="abrirModalAlunos()"><i class="fas fa-user" aria-hidden="true"></i> Selecionar</button>
                    </div>
                    ...
                    <button type="submit" class="btn-confirmar-emprestimo"><i class="fas fa-circle-check" aria-hidden="true"></i> Confirmar Empréstimo</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div id="modalLivros" class="modal-overlay">
        <div class="modal-conteudo">
            <div class="modal-header">
                <h2><i class="fas fa-book" aria-hidden="true"></i> Selecionar Livro</h2>
    ...
    <div id="modalAlunos" class="modal-overlay">
        <div class="modal-conteudo">
            <div class="modal-header">
                <h2><i class="fas fa-user" aria-hidden="true"></i> Selecionar Aluno</h2>
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn-novo-emprestimo" style="margin-top:1rem;width:100%;" onclick="window.location.href='usuarios.php?acao=novo'">
                    <i class="fas fa-user-plus" aria-hidden="true"></i> Cadastrar Novo Aluno
                </button>
            </div>
        </div>
    </div>
