 ...
 * Local: public/admin/cadastro_rapido_aluno.php
 * Funcao: Cadastro rapido de aluno usado durante o fluxo de emprestimo.
 */
// public/admin/cadastro_rapido_aluno.php
...
<body>
    ...
    <main>
            ...
            <div class="alerta alerta-sucesso">
                ...
                <div style="margin-top: 1rem;">
                    <a href="novo_emprestimo.php" style="color: var(--btn-primary-text); font-weight: 600; text-decoration: underline;">
                        Ir para Empréstimo <i class="fas fa-arrow-right" aria-hidden="true"></i>
                    </a>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="info-box">
            <h3><i class="fas fa-circle-info" aria-hidden="true"></i> Informações Importantes</h3>
