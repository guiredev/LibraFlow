 ...
 * Funcao: Edicao dos dados de um livro ja cadastrado.
 */
// public/admin/editar_livro.php
        ...
        if (isset($_FILES['capa']) && $_FILES['capa']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!$uploadValido) {
                ...
                if (move_uploaded_file($_FILES['capa']['tmp_name'], $destino)) {
                    if ($livro['capa']) {
                        $old = $_SERVER['DOCUMENT_ROOT'] . '/LibraFlow/public/catalogo/capas/' . $livro['capa'];
...
<body>
    <aside>
        ...
        <ul>
            ...
            <li class="nav-section">Biblioteca</li><li><a href="/LibraFlow/public/admin/listar_livros.php" class="ativo"><i class="fas fa-book-open nav-icon" aria-hidden="true"></i> Acervo</a></li>
    ...
    <nav>
        <div class="logo-nav"><span>Editar Livro</span></div>
        <div class="right">
    ...
    <main>
        <div class="form-card">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <a href="listar_livros.php" class="voltar" style="margin-left:2rem;"><i class="fas fa-arrow-left" aria-hidden="true"></i> Voltar</a>
            </form>
        </div>
    </main>
    <script>
