...
<body>
    <aside><div class="logo-aside"><span>LibraFlow</span></div><ul>
        ...
        <li><a href="/LibraFlow/public/admin/usuarios.php" class="ativo"><i class="fas fa-users nav-icon" aria-hidden="true"></i> Pessoas</a></li><li><a href="/LibraFlow/public/admin/visitas.php"><i class="fas fa-clock nav-icon" aria-hidden="true"></i> Visitas</a></li>
    ...
    <nav><div class="logo-nav"><span>Detalhe do Aluno</span></div><div class="right"><a class="admin-nav-link" href="/LibraFlow/public/admin/Admin.php"><i class="fas fa-house" aria-hidden="true"></i> Painel</a></div></nav>
