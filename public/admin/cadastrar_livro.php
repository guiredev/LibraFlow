...
<body>
    <aside>
        ...
        <ul>
            ...
            <li><a href="/LibraFlow/public/admin/cadastrar_livro.php" class="ativo"><i class="fas fa-plus nav-icon" aria-hidden="true"></i> Adicionar livro</a></li>
    ...
    <nav>
        <div class="logo-nav"><span>Cadastrar Livro</span></div>
        <div class="right">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <label class="upload-area" for="inputCapa">
                            ...
                            <strong><i class="fas fa-upload" aria-hidden="true"></i> Escolher capa</strong>
