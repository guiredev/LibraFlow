 ...
 * Local: public/auth/senha/redefinir-senha.php
 * Funcao: Tela que valida token de recuperacao e grava a nova senha.
 */
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            --border-color: #D9E7E4;
            --btn-primary: #4FBFAE;
            --btn-primary-hover: #37A391;
            --btn-primary-text: #FFFFFF;
            --shadow-sm: 0 1px 2px rgba(15, 31, 46, 0.06), 0 1px 8px rgba(15, 31, 46, 0.04);
        }
        ...
        body.dark {
            ...
            --border-color: #31484D;
            --btn-primary: #58C9B8;
            --btn-primary-hover: #43B09F;
            --btn-primary-text: #0E1A1D;
        }
...
<body>
    <div class="card">
        ...
        <?php if ($sucesso): ?>
            ...
            <a class="voltar" href="/LibraFlow/public/auth/login/login.php"><i class="fas fa-arrow-left" aria-hidden="true"></i> Ir para o login</a>
        ...
        <?php elseif ($tokenValido): ?>
            ...
            <a class="voltar" href="/LibraFlow/public/auth/login/login.php"><i class="fas fa-arrow-left" aria-hidden="true"></i> Voltar para o login</a>

        <?php else: ?>
            <a class="voltar" href="/LibraFlow/public/auth/senha/esqueceu-a-senha.php"><i class="fas fa-arrow-left" aria-hidden="true"></i> Solicitar novo link</a>
        <?php endif; ?>
    </div>
