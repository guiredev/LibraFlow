...
<body>
    <nav>
        ...
        <div class="links-nav">
            <ul>
                ...
                <li><a href="/LibraFlow/catalogo/meus_emprestimos.php">Meus Livros</a></li>
                <li><a href="/LibraFlow/catalogo/catalogo.php">Catalogo</a></li>
    ...
    <main>
        ...
        <section class="acoes-rapidas">
            <a href="/LibraFlow/catalogo/catalogo.php">Buscar livros</a>
            <a href="/LibraFlow/catalogo/meus_emprestimos.php">Ver emprestimos</a>
        </section>
                ...
                <?php else: ?>
                    <?php foreach ($livrosRecentes as $livro): ?>
                        ...
                        <article class="livro-card">
                            <?php if ($livro['capa']): ?>
                                <img src="/LibraFlow/catalogo/capas/<?= htmlspecialchars($livro['capa']) ?>" alt="Capa de <?= htmlspecialchars($livro['titulo']) ?>">
                            <?php else: ?>
