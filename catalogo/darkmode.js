/**
 * Dark Mode Toggle - LibraFlow (DEBUG VERSION)
 * Script para testar funcionamento no login
 */
...
(function() {
    ...
    function applyTheme(theme) {
        ...
        console.log('🔍 Icon encontrado:', !!icon);
        ...
        if (theme === 'dark') {
            ...
            console.log('✅ Light mode ativado - Classes:', body.className);
        }
    }
    ...
    function toggleTheme() {
        ...
        console.log('🔍 Classes antes:', body.className);

        applyTheme(newTheme);
        saveTheme(newTheme);

        console.log('🔍 Classes depois:', body.className);
    ...
    function initToggleButton() {
        ...
        console.log('✅ Botão de tema encontrado:', button);
